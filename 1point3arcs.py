...
def generatePopUpUrl(token):
    return "http://www.1point3acres.com/bbs/plugin.php?id=dsu_paulsign:sign&%s&infloat=yes&handlekey=dsu_paulsign&inajax=1&ajaxtarget=fwin_content_dsu_paulsign" % (
        token)
...
def request(_url, _data=None):
    ...
    req.add_header('User-Agent',
                   r"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36")
